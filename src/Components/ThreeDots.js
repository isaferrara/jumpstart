...
const ThreeDots = ({className}) => {
  ...
  return (
        ...
        <HoverMenus>
           <MenuButton>
              <svg width="14" height="19" viewBox="0 0 14 19" fill="none" style={{paddingRight:'10px'}} xmlns="http://www.w3.org/2000/svg">
          ...
          <MenuButton>
            <svg width="18" height="17" viewBox="0 0 18 17" fill="none" rigth='20px' style={{paddingRight:'10px'}} xmlns="http://www.w3.org/2000/svg">
            ...
            <MenuButton>
              <svg width="15" height="17" viewBox="0 0 15 17" fill="none"  style={{paddingRight:'10px'}} xmlns="http://www.w3.org/2000/svg">
